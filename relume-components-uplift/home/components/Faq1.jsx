        ...
        <Accordion type="multiple">
          <AccordionItem value="item-0">
            ...
            <AccordionContent className="md:pb-6">
              ...
              complex challenges, improve operations, and achieve measurable
              growth.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent className="md:pb-6">
              ...
              methodologies, and deep industry insights that accelerate
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent className="md:pb-6">
              ...
              improvements and actionable outcomes that directly impact your
              bottom line.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
