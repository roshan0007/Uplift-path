...
/**
 * Re-skinned to the 2026-09-09 Figma (frame `Resource Assistance`), which draws
 * this banner exactly as the nine v3 frames already built do: white rather
 * than green, copy left-aligned, envelope illustration beside it. It was
 * `scheme-2` (Caribbean Green) with centred copy and no illustration. Tenth
