    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28 scheme-3 badge-alt alternate logo-alt">
      <div className="container">
        <div className="grid grid-cols-1 items-start gap-y-12 md:grid-flow-row md:grid-cols-2 md:gap-x-12 lg:gap-x-20">
          ...
          <div>
            <Card className="mb-8 border-none sticky p-8" style={{ top: "30%" }}>
            ...
            <Card className="mb-8 border-none sticky p-8" style={{ top: "32%" }}>
              <div className="mb-3 md:mb-4">
                <img
                  className="size-12 text-scheme-text"
            ...
            <Card className="mb-8 border-none sticky p-8" style={{ top: "34%" }}>
              <div className="mb-3 md:mb-4">
                <img
                  className="size-12 text-scheme-text"
            ...
            <Card className="mb-8 border-none sticky p-8" style={{ top: "36%" }}>
              <div className="mb-3 md:mb-4">
                <img
                  className="size-12 text-scheme-text"
