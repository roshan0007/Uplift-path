...
/**
 * Re-skinned to the 2026-09-09 Figma (frame `System & Technology`), which draws
 * this banner exactly as the seven v3 frames already built do: white rather
 * than green, copy left-aligned, envelope illustration beside it. It was
 * `scheme-2` (Caribbean Green) with centred copy and no illustration. Eighth
