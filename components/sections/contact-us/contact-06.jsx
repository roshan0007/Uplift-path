      ...
      <div className="container grid grid-cols-1 items-start gap-y-12 md:grid-flow-row md:grid-cols-2 md:gap-x-12 lg:grid-flow-col lg:gap-x-20 lg:gap-y-16">
        <div>
          <div className="mb-6 md:mb-8">
            ...
            <h2 className="mb-5 text-h2 font-bold md:mb-6">Send us a note</h2>
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            ...
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="#first_choice">Business owner</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="second_choice" id="#second_choice" />
                <Label htmlFor="#second_choice">Individual</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="third_choice" id="#third_choice" />
                <Label htmlFor="#third_choice">Startup founder</Label>
              </div>
              <div className="flex items-center space-x-2">
