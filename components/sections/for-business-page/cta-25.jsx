...
/**
 * Re-skinned to the 2026-09-08 Figma (node 10214-104878), which draws this
 * banner exactly as the homepage, About Us, How We Work and For Individual v3
 * frames do: white rather than green, copy left-aligned, and the envelope
 * illustration beside it. It was `scheme-2` (Caribbean Green) with centred copy
 * and no illustration. This is the fifth copy of a decision already taken.
 *
 * The same illustration node backs all five frames, and it already ships as
 ...
 * in `globals.css`.
 *
 * Unlike the For Individual copy of this section, the button keeps its
 * `/contact-us` destination rather than opening the intake Application modal.
 * That modal drives Peer Coach matching -- Application, Eligibility,
 * Scheduling, Consent -- which is the individual offering; an organisation
 * booking a discovery call belongs in the contact form.
 */
