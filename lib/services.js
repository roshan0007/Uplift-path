 ...
 * same seven services as cards: the nav and the page have to say the same thing,
...
export const BUSINESS_SERVICES = [
  ...
  },
  {
    label: "Marketing",
    description:
      "HIPAA- and CARF-aware marketing for care organizations: positioning, local search, referrals and content.",
    short: "Compliance-safe marketing for care organizations.",
    href: "/marketing",
    icon: "campaign",
  },
  {
