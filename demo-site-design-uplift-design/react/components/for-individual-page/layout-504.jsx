          ...
          >
            <Card className="grid grid-cols-1 md:grid-cols-2 md:items-center">
              <div className="aspect-square">
                <img
                  src="https://imagedelivery.net/RAP5LnVUMDfmG3LRL4kHtw/2a9d8925-b860-44e2-e5fc-0ba254c0d301/2560?exp=1788307200&sig=db971dc29f4bddf550b0b9e6a41a3bbaba76ff471e4a4b923abc27a1ff99b02f"
