        ...
        <div className="grid auto-cols-fr grid-cols-1 gap-6 md:gap-8 lg:grid-cols-3">
          <Card className="flex flex-col">
            <div className="flex w-full flex-col items-center justify-center self-start">
              <img
                src="https://imagedelivery.net/RAP5LnVUMDfmG3LRL4kHtw/61c54a1e-540e-4572-a181-4624b1e89a01/2560?exp=1788307200&sig=5529eae92b2991863e9b6f9f907e8766f8476ea0ab9be0c718e1dffec61ea9a9"
          ...
          <Card className="flex flex-col">
            <div className="flex w-full flex-col items-center justify-center self-start">
              <img
                src="https://imagedelivery.net/RAP5LnVUMDfmG3LRL4kHtw/02d6db19-d456-439b-d418-1786b519c801/2560?exp=1788307200&sig=3d9c2bffcf44be62c5817d6306bb1210219d8ca1a6882cbe9a9202ca01eb6829"
                alt="Relume placeholder image 1"
              />
            </div>
            <div className="flex flex-1 flex-col justify-center p-6 md:p-8">
          ...
          <Card className="flex flex-col">
            <div className="flex w-full flex-col items-center justify-center self-start">
              <img
                src="https://imagedelivery.net/RAP5LnVUMDfmG3LRL4kHtw/b2cd085d-5de9-45d9-fa98-b9ada3e40f01/2560?exp=1788307200&sig=86cbdfd911585de353e9d0288410c277f554eee9e6fe71eb76f0dce862c61df4"
                alt="Relume placeholder image 1"
              />
            </div>
            <div className="flex flex-1 flex-col justify-center p-6 md:p-8">
