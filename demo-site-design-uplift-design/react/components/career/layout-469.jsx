        ...
        <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2 md:gap-x-16">
          ...
          <div className="relative flex">
            <div className="absolute top-[10%] left-0 w-1/2">
              <img
                src="https://imagedelivery.net/RAP5LnVUMDfmG3LRL4kHtw/b42d8786-1d55-410e-619e-fce6346b3401/2560?exp=1788307200&sig=c38e10de0e3d292594137ed31f29e09bbcd5df7b7fc22970290d8db5a59b8955"
            ...
            <div className="ml-[30%]">
              <img
                src="https://imagedelivery.net/RAP5LnVUMDfmG3LRL4kHtw/511af2af-fb32-4e69-b804-09f37952f001/2560?exp=1788307200&sig=9102d3622048be030eb17ce0ba38acc4937a850dba835a2ef99066aa35f075f5"
