      ...
      <div className="container">
        ...
        <Card className="grid auto-cols-fr grid-cols-1 md:grid-cols-2">
          <div className="flex items-center justify-center">
            <img
              src="https://imagedelivery.net/RAP5LnVUMDfmG3LRL4kHtw/67e3225d-408c-47f9-bb9f-1511f50f2601/2560?exp=1788307200&sig=5b3aeee43e5b2ae8f8aa5ca6aaa286c77514020d1ad06125470f52a9521755b1"
